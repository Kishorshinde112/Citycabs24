      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {activeTab === 'rates' && (
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-3xl border border-slate-200 shadow-xl overflow-hidden">
              ...
              {/* Policy & Important Terms Box (Exact from Image 1) */}
          ...
          <div className="bg-white rounded-3xl border border-slate-200 shadow-xl overflow-hidden p-6 sm:p-8 space-y-6 animate-fadeIn">
            ...
            <div className="bg-slate-50 rounded-2xl p-4 border border-slate-200 flex flex-wrap items-center justify-between gap-4">
              <div className="text-xs text-slate-600">
                <span className="font-bold text-slate-900">Recommended Vehicles:</span> Sedan (Dzire) from <strong>Rs. 2,500/-</strong> | Ertiga (6+1) from <strong>Rs. 3,200/-</strong>
              </div>
              <button
                onClick={() => setActiveTab('rates')}
                className="text-xs font-bold text-indigo-600 hover:text-indigo-800 underline cursor-pointer"
              >
                View Complete Car Pricing Table →
              </button>
            </div>
          </div>
        )}
        ...
        {activeTab === 'north' && (
          <div className="bg-white rounded-3xl border border-slate-200 shadow-xl overflow-hidden p-6 sm:p-8 space-y-6 animate-fadeIn">
            ...
            <div className="bg-slate-50 rounded-2xl p-4 border border-slate-200 flex flex-wrap items-center justify-between gap-4">
              <div className="text-xs text-slate-600">
                <span className="font-bold text-slate-900">Recommended Vehicles:</span> Sedan from <strong>Rs. 2,500/-</strong> | Ertiga from <strong>Rs. 3,200/-</strong> | Carens from <strong>Rs. 3,500/-</strong>
              </div>
              <button
                onClick={() => setActiveTab('rates')}
                className="text-xs font-bold text-indigo-600 hover:text-indigo-800 underline cursor-pointer"
