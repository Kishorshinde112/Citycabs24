      ...
      <div className="bg-slate-900 text-slate-200 text-xs py-2 px-4 border-b border-slate-800 hidden md:block">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            <a 
              href="https://wa.me/917021001921?text=Hi%20CityTourCabs,%20I%20would%20like%20to%20inquire%20about%20a%20cab%20booking."
              target="_blank"
              rel="noreferrer"
            ...
            <a 
              ...
              className="text-amber-400 font-bold hover:text-amber-300 flex items-center transition"
            >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center">
            ...
            <a href="#home" className="flex items-center gap-3 group">
              <div className="w-11 h-11 rounded-xl bg-gradient-to-tr from-amber-500 via-amber-400 to-yellow-300 p-0.5 shadow-md group-hover:scale-105 transition-transform flex items-center justify-center">
              ...
              <div>
                <div className="flex items-center gap-1.5">
                  <span className="font-display font-black text-2xl tracking-tight text-slate-900">
                    CityCabs<span className="text-amber-500">24</span>
                  </span>
                </div>
            ...
            <div className="hidden lg:flex items-center space-x-1">
              {navLinks.map((link) => (
                <a
                  key={link.name}
                  href={link.href}
                  className="px-3 py-2 rounded-lg text-sm font-semibold text-slate-700 hover:text-amber-600 hover:bg-amber-50/70 transition"
                >
                  {link.name}
                </a>
              ))}
            ...
            <div className="hidden md:flex items-center space-x-3">
              <a
                href="https://wa.me/917021001921?text=Hi%20CityTourCabs,%20I%20want%20to%20check%20cab%20rates%20and%20availability."
                target="_blank"
                rel="noreferrer"
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-white text-sm font-bold shadow-md hover:shadow-amber-500/30 transition transform hover:-translate-y-0.5"
              >
                <span>Book Ride</span>
              </button>
            </div>
            ...
            <div className="flex lg:hidden items-center gap-2">
              <a
                href="tel:+917021001921"
                className="p-2 rounded-lg bg-amber-50 text-amber-600 border border-amber-200"
                aria-label="Call Now"
              >
          ...
          <div className="lg:hidden border-t border-slate-200 bg-white px-4 pt-3 pb-6 space-y-2 animate-fadeIn">
            ...
            {navLinks.map((link) => (
              <a
                ...
                className="block px-3 py-2.5 rounded-lg text-base font-medium text-slate-800 hover:bg-amber-50 hover:text-amber-600 transition"
              >
                {link.name}
              </a>
            ))}
            ...
            <button
              ...
              className="w-full mt-3 py-3 rounded-xl bg-gradient-to-r from-amber-500 to-amber-600 text-white font-bold text-sm shadow-md"
            >
